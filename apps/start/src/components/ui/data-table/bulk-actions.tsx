...
const getCurrentButtonIndex = (buttons: NodeListOf<HTMLButtonElement>) =>
...
export function DataTableBulkActions<TData>({
  ...
  const handleKeyDown = (event: React.KeyboardEvent) => {
    ...
    const currentIndex = getCurrentButtonIndex(buttons);
    handleNavigationKey(event, buttons, currentIndex);
  };
