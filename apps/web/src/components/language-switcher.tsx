...
function LanguageSwitcherInner({ className, locale }: { className?: string; locale?: Locale }) {
...
export const LanguageSwitcher = ({ className, locale }: Props) => (
  <LanguageSwitcherInner className={className} locale={locale} />
);
