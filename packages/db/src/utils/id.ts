...
export type CollectionSkillId = Brand<string, "collections_skills">;
...
export type SandboxAgentId = Brand<string, "sandbox_agents">;
export type SkillEvalSuiteId = Brand<string, "skill_eval_suites">;
export type SkillEvalCaseId = Brand<string, "skill_eval_cases">;
export type SkillEvalRunId = Brand<string, "skill_eval_runs">;
export type SkillEvalCaseResultId = Brand<string, "skill_eval_case_results">;
export type SkillUsageEventId = Brand<string, "skill_usage_events">;
...
export const asCollectionSkillId = (value: string) => value as CollectionSkillId;
...
export const asSandboxAgentId = (value: string) => value as SandboxAgentId;
export const asSkillEvalSuiteId = (value: string) => value as SkillEvalSuiteId;
export const asSkillEvalCaseId = (value: string) => value as SkillEvalCaseId;
export const asSkillEvalRunId = (value: string) => value as SkillEvalRunId;
export const asSkillEvalCaseResultId = (value: string) => value as SkillEvalCaseResultId;
export const asSkillUsageEventId = (value: string) => value as SkillUsageEventId;
